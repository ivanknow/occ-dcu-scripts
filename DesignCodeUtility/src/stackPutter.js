...
function putStack(path) {
  ...
  // If we grabbed a non-Oracle stack from a pre-17.6 system there will not
  // be enough information to create it again. This is an edge case but we
  // need to do the right thing.
  if (localStackMetadata.source !== 101) {
    warn("insufficientInfoToCreateStack", {stackName: localStackMetadata.displayName})
    return
  }
